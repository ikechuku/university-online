...
urlpatterns = [
    ...
    # departments/department/2
     url(r'course/(?P<pk>[0-9]+)/$', views.DepartmentUpdateView.as_view(), name='update-course'),

    # departments/department/2/delete
     url(r'course/(?P<pk>[0-9]+)/delete', views.DepartmentDeleteView.as_view(), name='delete-course'),
]
